        ...
        class ChooseNextSpeaker(OpenAISchema):
            ...
            async def run(self) -> AsyncGenerator[str, None]:
                ...
                if self.goal_achieved == 'false':
                    ...
                    async for m in descriptions[self.r_id]["agent"].get_completion(self.message, threadname=outerself.threadname):
                        yield m
                else:
...
class Joiner(Agent):
    def __init__(self, name, model: str = "gpt-4-1106-preview", id=0, **kwargs) -> None:
...
class GoalMaker(Agent):
    def __init__(self, name, model: str = "gpt-4-1106-preview", **kwargs) -> None:
